        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
              <div>
                <span className="text-gray-500 block mb-1">نام مشتری</span>
                <span className="font-medium text-gray-800">
                  {order.customer_name}
                </span>
              </div>
              <div>
                <span className="text-gray-500 block mb-1">تلفن</span>
                <span className="font-medium text-gray-800" dir="ltr">
                  {order.customer_phone}
                </span>
              </div>
              <div className="sm:col-span-2">
                <span className="text-gray-500 block mb-1">آدرس</span>
                <span className="font-medium text-gray-800">
